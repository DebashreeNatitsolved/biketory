...
/**
 * Generated class for the EditSellerProfilePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-edit-seller-profile',
  templateUrl: 'edit-seller-profile.html',
})
export class EditSellerProfilePage {
  formGroup:FormGroup;
  user_details: any;
  user_id: any;
  userSet: any;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, 
    public bikeService: BikeProvider, public alertCtrl: AlertController, public storage:Storage) {
...
"user_id":this.user_id,
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad EditSellerProfilePage');
